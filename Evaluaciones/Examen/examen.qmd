...
**R:** - R es un lenguaje de código abierto y multiplataforma. - Por que ha tenido un alto crecimiento en cuanto al análisis de datos geoespaciales. - Por las ventajas que tiene para análisis de datos.

2.  (20pts) ¿Para qué sirve la libreria `GDAL`?

**R:** Para manejar datos vectoriales y raster.
...
**R:**\
\* Es uno de los objetos más destacados, nace del mundo de software de análisis estadístico. \* Cada columna corresponde a una variable y cada fila a una observación. \* Puede almacenar columnas con diferentes tipos de datos
