...
- Extraiga cinco entidades espaciales y haga un mapa de cada una - Indique el codigo EPSG de cada una de las capas vectoriales (canales, estaciones, comunas) - Transforme el sistema de referencia de coordenadas de las tres capas vectoriales a datum WGS84 coordenadas geográficas.
