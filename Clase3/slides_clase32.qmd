...
## Simple Feature `{sf}`: __Dimensiones__
...
## Simple Feature `{sf}`: __Tipos de geometrías__ {.smaller}
...
## Simple Feature `{sf}`: __Clase `sf`__
...
### Simple Feature `{sf}`: __Clase `sfc`__
...
# 3.  Datos espaciales raster {background-color='ocean'}
