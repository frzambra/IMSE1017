...
## 1 Motivación {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## 2. Ranking popularidad `R` {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
