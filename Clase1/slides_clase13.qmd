...
## 1. Sintaxis de R {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Numeric: integer o double {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character: algunas funciones útiles {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Logical {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Valores faltantes (NA: Not Available) {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Date-time {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Factor {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Vectores {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Atomic vectors {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Numeric vector: algunas funciones {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character vector: algunas funciones {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character vector {background-image="../img//img//R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
