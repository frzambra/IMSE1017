...
## Contenidos {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
::: incremental
1. Sintaxis de R
...
## Algunos consejos {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
::: incremental
...
##  Instalar `R` {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
- Si deseas instalar R en tu PC 
  - [Descargar R](https://www.r-project.org/)
  - Descargar una IDE, aconsejo [RStudio](https://rstudio.com/)

## Explorando RStudio {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## 1.R como una calculadora {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## 1. Sintaxis de R {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Numeric: integer o double {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character: algunas funciones útiles {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Logical {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Valores faltantes (NA: Not Available) {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Date-time {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Factor {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Vectores {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Atomic vectors {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Numeric vector: algunas funciones {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character vector: algunas funciones {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Character vector {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## List: es un tipo de vector {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Matrix {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Matrix: algunas funciones {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
...
## Data.frame {background-image="../R_logo.png" background-position="97.5% 2.5%" background-size="7.5%" layout="true" .smaller}
