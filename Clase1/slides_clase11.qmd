...
::: incremental
- Que los alumnos logren habilidades en el manejo y aplicacion de operaciones geospaciales con datos vectoriales y raster mediante el uso del `software R`.

- Adquirir los conceptos fundamentales de teledetección.
...
## Ausencia clase 2 septiembre 

```{r}
#| echo: false
knitr::include_url({"https://opengeohub.org/summer-school/siegburg-2022/"})
```
